...
export const blogSeedPosts = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "Aroha is the only one on this list with a fully-managed white-glove setup at the same price as the DIY tools. Managed by Aroha Group and available for NZ and US customers. Plans NZ$99-$599 (US$45-$269). Includes Aurora business chatbot for staff, plus Email AI and CRM with the Essentials plan and up." },
