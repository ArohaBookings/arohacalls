...
export const PLANS: readonly Plan[] = [
  {
    ...
    capabilities: [
      { category: "voice", label: "24/7 AI receptionist", detail: "Books-only mode with a friendly brand voice." },
...
export const FEATURE_MATRIX: {
  ...
  },
  {
    ...
    rows: [
      ...
      { feature: "Natural brand voice", lite: true, essentials: true, professional: true, premium: true },
