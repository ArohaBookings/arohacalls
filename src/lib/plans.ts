...
export const PLANS: readonly Plan[] = [
  {
    ...
    capabilities: [
      { category: "voice", label: "24/7 AI receptionist", detail: "Books-only mode with a friendly local voice." },
      { category: "voice", label: "Aroha business number", detail: "Use a new Aroha number, forward your existing line, or port your number later." },
      { category: "calendar", label: "Managed Google Calendar setup", detail: "Connect Google Calendar inside your managed Aroha AI organisation. We configure services, buffers and booking rules." },
    ...
    whatsInTheBox: [
      "1 Aroha business number activated within 24 hours",
      "100 inbound AI minutes per month",
      "Aroha AI dashboard login",
      "Google Calendar connected through your managed Aroha AI organisation",
    ...
    faq: [
      ...
      { q: "Can I keep my existing number?", a: "Yes. You can use a new Aroha number, forward your current number to Aroha, or port your current number later." },
  ...
  },
  {
    ...
    capabilities: [
      ...
      { category: "calendar", label: "Smart booking + reminders", detail: "Google Calendar connects through your managed Aroha AI organisation, then we tune booking rules, buffers and confirmations." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Can the 2 numbers be in different countries?", a: "Yes. We can set up supported numbers in different countries, or combine a new Aroha number with forwarding from your existing line." },
...
export const FEATURE_MATRIX: {
...
}[] = [
  {
    ...
    rows: [
      ...
      { feature: "Multi-country numbers", lite: "—", essentials: "—", professional: true, premium: true },
    ],
  },
  {
    ...
    rows: [
      ...
      { feature: "Natural local voice", lite: true, essentials: true, professional: true, premium: true },
