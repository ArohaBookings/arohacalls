...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card p-6 shadow-2xl transition ease-in-out border-border data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300",
  {
    variants: {
      side: {
